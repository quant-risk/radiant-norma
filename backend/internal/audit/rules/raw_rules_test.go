...
func TestBuiltin3040_TotalRulesIs(t *testing.T) {
	...
	// Sprint 52: +6 XD-DLI-01 a XD-DLI-06 (cross-doc DLI × DRL × DLP).
	// Total Registry: 5 raw + 267 tipadas = 272.
	if total != 272 {
		t.Errorf("Total regras = %d, want 272 (Sprint 52: 266 + 6 XD-DLI)", total)
	}
}
