/**
 * /console — dashboard executivo (autenticado).
 *
 * Server component: detecta sessão via getServerSession(). Se deslogado,
 * redireciona para /login. Senão, renderiza dashboard com dados reais.
 */
...
export default async function ConsolePage() {
  ...
  if (!data) {
    // Não autenticado → redireciona para /login com ?next=/console
